...
import musite.io.text.PhosphoPeptideProteinsReader;
 ...
 */
public class PhosphoPeptide2MusiteDialog extends javax.swing.JDialog {

    /** Creates new form Fasta2XmlDialog */
    public PhosphoPeptide2MusiteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Convert from Phosphopeptides to Musite XML");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        fromPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("From phosphorylation peptide report"));
    ...
    private void OKBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKBtnActionPerformed
        ...
        if (dirFrom.length()==0) {
            JOptionPane.showMessageDialog(this, "Error: specify a PhosphoPeptide report file.");
            return;
        }
        ...
        //Reading
        PhosphoPeptideProteinsReader phosReader = new PhosphoPeptideProteinsReader(proteins);
        phosReader.setAmbiguityFilter(includeAmbiguousCheckBox.isSelected()?
            PhosphoPeptideProteinsReader.AmbiguityFilter.BOTH:
            PhosphoPeptideProteinsReader.AmbiguityFilter.NONAMBIGOUS);

        readTask = new ReadTask(phosReader, dirFrom);
        TaskUtil.execute(readTask);
        if (!readTask.success()) {
            JOptionPane.showMessageDialog(this, "Failed to read the Phosphopeptide report.");
            return;
        }
