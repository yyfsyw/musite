...
public class MusiteTrainDialog extends javax.swing.JDialog {
    ...
    private void OKBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKBtnActionPerformed
        ...
        final int maxSize = 20000; // TODO: make this an option
        ...
        Proteins.ProteinFilter proteinFilter = new Proteins.ProteinFilter() {
            public boolean filter(Protein protein) {
                ...
                if (Math.random()<1.0*maxSize/(n+1)) {
                    ...
                    proteins.removeProtein(accs.get(ixRmv)); // replace a previous protein
        ...
        switch(fileTypeTabbedPane.getSelectedIndex()) {
            ...
            case 1: {
                Reader<Proteins> reader = new ModifiedProteinsFastaReaderBuilder()
                        .ptm(ptm).filter(proteinFilter).proteins(proteins).build();
        ...
        if (!modelName.endsWith("."+MusiteInit.MODEL_APPEDIX))
            modelName += "."+MusiteInit.MODEL_APPEDIX;
        ...
        succ = true;
        musite.MusiteInit.initializeModels(); // load the model
    ...
    private boolean verifyInput() {
        ...
        if (!dirModel.endsWith("."+MusiteInit.MODEL_APPEDIX))
            dirModel += "."+MusiteInit.MODEL_APPEDIX;
