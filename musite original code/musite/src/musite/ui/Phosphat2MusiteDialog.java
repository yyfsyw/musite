...
import musite.io.text.PhosPhAtReportProteinsReader;
 ...
 */
public class Phosphat2MusiteDialog extends javax.swing.JDialog {

    /** Creates new form Fasta2XmlDialog */
    public Phosphat2MusiteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        includeAmbiguousCheckBox = new javax.swing.JCheckBox();
        javax.swing.JPanel ppmPanel = new javax.swing.JPanel();
        ppmCheckBox = new javax.swing.JCheckBox();
        ppmTextField = new javax.swing.JTextField();
        javax.swing.JPanel OKPanel = new javax.swing.JPanel();
        OKBtn = new javax.swing.JButton();
        javax.swing.JButton cancelBtn = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Convert from PhosPhAt report to Musite XML");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        fromPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("From PhosPhAt report"));
        ...
        opPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Options"));
        opPanel.setLayout(new java.awt.GridBagLayout());

        includeAmbiguousCheckBox.setText("Include ambiguous sites");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        opPanel.add(includeAmbiguousCheckBox, gridBagConstraints);

        ppmPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        ppmCheckBox.setText("PPM threshold (<=):");
        ppmPanel.add(ppmCheckBox);

        ppmTextField.setText("3.0");
        ppmTextField.setPreferredSize(new java.awt.Dimension(60, 19));
        ppmPanel.add(ppmTextField);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        opPanel.add(ppmPanel, gridBagConstraints);
    ...
    private void fromFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fromFileButtonActionPerformed
        ...
        fc.setDialogTitle("Select a PhosPhAt report file...");
    ...
    private void OKBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKBtnActionPerformed
        ...
        if (dirFrom.length()==0) {
            JOptionPane.showMessageDialog(this, "Error: specify a PhosPhAt report file.");
            return;
        }
        ...
        Double ppm = null;
        if (ppmCheckBox.isSelected()) {
            String text = ppmTextField.getText().trim();
            if (text.length()==0) {
                JOptionPane.showMessageDialog(this, "Error: specify ppm threhold.");
                return;
            }

            try {
                ppm = Double.parseDouble(text);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Error: ppm threhold should be a positive number, say 3.0.");
                return;
            }
        ...
        //Reading
        PhosPhAtReportProteinsReader phosphatReader = new PhosPhAtReportProteinsReader(proteins);
        phosphatReader.setFilter(ppm, includeAmbiguousCheckBox.isSelected(), null, null);

        readTask = new ReadTask(phosphatReader, dirFrom);
        TaskUtil.execute(readTask);
        if (!readTask.success()) {
            JOptionPane.showMessageDialog(this, "Failed to read the PhosPhAt report.");
            return;
        }
    ...
    private javax.swing.JCheckBox includeAmbiguousCheckBox;
    private javax.swing.JCheckBox ppmCheckBox;
    private javax.swing.JTextField ppmTextField;
