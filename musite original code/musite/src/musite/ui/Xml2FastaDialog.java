...
import musite.io.fasta.ModifiedProteinsFastaWriter;
 ...
 */
public class Xml2FastaDialog extends javax.swing.JDialog {

    /** Creates new form Fasta2XmlDialog */
    public Xml2FastaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        toPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Save to FASTA File"));
    ...
    private void fromFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fromFileButtonActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            toFileTextField.setText(MusiteInit.defaultPath+File.separator+fileName+".fasta");
        }
    ...
    private void OKBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKBtnActionPerformed
        ...
        if (dirTo.length()==0) {
            JOptionPane.showMessageDialog(this, "Error: specify the fasta file to save.");
            return;
        }

        if (musite.util.IOUtil.fileExist(dirTo)) {
            int ret = JOptionPane.showConfirmDialog(this, "Are you sure to replace the existing fasta file?",
        ...
        //Write to fasta file
        ModifiedProteinsFastaWriter writer = new ModifiedProteinsFastaWriter();
        WriteTask writeTask = new WriteTask(proteins, writer, dirTo);
        TaskUtil.execute(writeTask);
        if (!readTask.success()) {
            JOptionPane.showMessageDialog(this, "Failed to write the FASTA file");
            return;
        }

        JOptionPane.showMessageDialog(this, "Successfully converted from Musite XML to FASTA.");
