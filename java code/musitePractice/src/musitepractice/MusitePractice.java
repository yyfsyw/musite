...
public class MusitePractice {
    ...
    static int getTrainingDataSet(HashMap<String, ArrayList<Double>> positiveFeatures, HashMap<String, ArrayList<Double>> negativeFeatures, HashMap<String, ArrayList<Double>> tempForBalance, char middleLetterInFrag) throws FileNotFoundException{
                ...
                if(nextToken.contains(">"))
                {
                    ...
                    if(sampleNo!=1){
                        ...
                        if(validStr!=null)//if the input is valid
                        {
                            ...
                            //System.out.println(validStr);
                            CreateFrag.outFrag(validStr, 5, middleLetterInFrag, positive, negative, null, siteSet);
...
//            
    ...
    static void testASequence(HashMap<String, ArrayList<Double>> positiveFeatures, HashMap<String, ArrayList<Double>> negativeFeatures, String testSeq, int sampleNo, char middleLetterInFrag){
        ...
        ArrayList<Integer> kPosition = CreateFrag.outFrag(testSeq, 5, middleLetterInFrag, null, null, testFragsInASeq, null);
    ...
    public static void main(String[] args) throws FileNotFoundException{
        ...
        String middleLetter = args[0];
        char [] charArr=middleLetter.toCharArray();
        char middleLetterInFrag = charArr[0];
        ...
        int lessSet = getTrainingDataSet(positiveFeatures, negativeFeatures, tempForBalance,middleLetterInFrag);
...
//            }
    ...
    for(int k=0; k<testSeqs.size();k++){
                //System.out.println("@@@@@@@@testSeqs : "+testSeqs.get(k));
               ...
               if(validStr_test!=null)//if the input is valid
                   
                       {
                           ...
                           if(lessSet == 1)    testASequence(positiveFeatures, tempForBalance, validStr_test, k+1,middleLetterInFrag);
                           else testASequence(tempForBalance, negativeFeatures, validStr_test, k+1,middleLetterInFrag);
                       }
               else System.out.println(">Seq "+(k+1)+"\t"+"invalid sequence");
           }
